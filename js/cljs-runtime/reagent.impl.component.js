...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21552 = c;
var G__21552__$1 = (((G__21552 == null))?null:G__21552.prototype);
if((G__21552__$1 == null)){
return null;
} else {
return G__21552__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21564 = c;
var G__21564__$1 = (((G__21564 == null))?null:G__21564.prototype);
if((G__21564__$1 == null)){
return null;
} else {
return G__21564__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__21613 = c;
var G__21613__$1 = (((G__21613 == null))?null:G__21613.constructor);
if((G__21613__$1 == null)){
return null;
} else {
return G__21613__$1.displayName;
}
})();
...
var G__21616 = c;
var G__21616__$1 = (((G__21616 == null))?null:G__21616.constructor);
if((G__21616__$1 == null)){
return null;
} else {
return G__21616__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21623 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21625 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21625);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21623);
}});
...
var c = this;
var G__21628_21644 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21628_21644 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21628_21644);
}
...
var renders_21645 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21646 = cljs.core.first(cljs.core.vals(renders_21645));
...
if((cljs.core.count(renders_21645) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21645))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21646)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21646], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21629 = o;
reagent.impl.component.goog$module$goog$object.set(G__21629,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21630 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21631 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21631);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21630);
}});
...
var vec__21632 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21632,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21632,(1),null);
...
var G__21635 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21635 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21635);
}
});
}),[]);
